...
import React, { useRef } from 'react'; // <--- Nhớ import useRef
...
const LandingPage = () => {
  ...
  // 2. DỮ LIỆU NHÀ HÀNG
  const restaurants = [
    { id: 1, name: "Hải sản Trần Long", address: "Số 888, Bến Nghé, Q1", rating: 9.5, img: "https://placehold.co/300x200/FFF3E0/E65100?text=Hai+San" },
    { id: 2, name: "Kichi Kichi", address: "Số 12, Võ Văn Tần, Q3", rating: 9.5, img: "https://placehold.co/300x200/FFF3E0/E65100?text=Kichi" },
    { id: 3, name: "Bít tết Nha Trang", address: "Số 5, Nguyễn Trãi, Q5", rating: 9.5, img: "https://placehold.co/300x200/FFF3E0/E65100?text=Bit+Tet" },
    { id: 4, name: "Gà hấp Đinh Tiên", address: "Số 99, CMT8, Q10", rating: 9.5, img: "https://placehold.co/300x200/FFF3E0/E65100?text=Ga+Hap" },
  ];
                ...
                {restaurants.map(res => (
                    <div key={res.id} className="card">
                        ...
                        <div className="card-body">
                            <h3 style={{fontSize:'16px', marginBottom:'5px', fontWeight:'700'}}>{res.name}</h3>
            ...
            <div className="card-grid">
                {restaurants.map((res, idx) => (
                    <div key={idx} className="card">
                        ...
                        <div className="card-body">
                            <h3 style={{fontSize:'16px', marginBottom:'5px', fontWeight:'700'}}>Món Ngon {idx+1}</h3>
                            <p style={{fontSize:'12px', color:'#666'}}>📍 {res.address}</p>
                            <div style={{fontSize:'12px', marginTop:'8px', color:'#E65100', fontWeight:'bold'}}>
                                ⭐ 9.8
                            </div>
