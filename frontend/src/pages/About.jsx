...
const About = () => {
  return (
    <div className="page-wrapper"> {/* Wrapper chung */}
      <Header />

      {/* Hero Section: Full width nền cam */}
      <div className="about-hero">
        <div className="container"> {/* Container để nội dung vào giữa */}
            <h1>Về Chúng Tôi</h1>
      ...
      <div className="container about-content">
        <section className="about-section">
            <div className="about-text">
                ...
                <p>
                    Được thành lập vào năm 2025, <b>Chewz</b> không chỉ là một ứng dụng tìm kiếm nhà hàng. 
                    Chúng tôi là người bạn đồng hành sành ăn, giúp bạn khám phá những góc ẩm thực tuyệt vời nhất 
                    tại Sài Gòn, từ những quán vỉa hè đậm chất cho đến những nhà hàng sang trọng bậc nhất.
                </p>
                <p>
      ...
      <footer className="footer-bg">
         ...
         <div className="footer-copyright">© 2025 Chewz. All rights reserved.</div>
      </footer>
    </div>
  );
};
