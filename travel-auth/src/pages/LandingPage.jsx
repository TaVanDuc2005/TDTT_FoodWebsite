...
const LandingPage = () => {
  const restaurants = [
    { id: 1, name: "Hải sản Trần Long", address: "Số 888, Bến Nghé, Q1", rating: 9.5, img: "https://placehold.co/300x200?text=Hai+San" },
    { id: 2, name: "Kichi Kichi", address: "Số 12, Võ Văn Tần, Q3", rating: 9.5, img: "https://placehold.co/300x200?text=Kichi" },
    { id: 3, name: "Bít tết Nha Trang", address: "Số 5, Nguyễn Trãi, Q5", rating: 9.5, img: "https://placehold.co/300x200?text=Bit+Tet" },
    { id: 4, name: "Gà hấp Đinh Tiên", address: "Số 99, CMT8, Q10", rating: 9.5, img: "https://placehold.co/300x200?text=Ga+Hap" },
  ];

  return (
    <div> {/* Div bao ngoài cùng không cần class */}
      <Header /> 
      ...
      <div className="search-section-bg">
        <div className="container search-content">
            ...
            <div className="filter-row">
                ...
                <select><option>Phù hợp</option></select>
                <select><option>Đồ ăn</option></select>
            </div>
        </div>
      </div>
      ...
      <main className="container main-content">
        <div className="category-icons">
            {['Lẩu', 'Buffet', 'Nướng', 'Hải sản', 'Nhậu', 'Sushi', 'Món chay'].map((item, index) => (
                ...
                {restaurants.map(res => (
                    <div key={res.id} className="card">
                        ...
                        <div className="card-body">
                            <h3 style={{fontSize:'15px', marginBottom:'5px'}}>{res.name}</h3>
            ...
            <div className="card-grid">
                {restaurants.map((res, idx) => (
                    <div key={idx} className="card">
                         <img src={`https://placehold.co/300x200?text=Mon+Viet+${idx+1}`} alt="Mon" className="card-img" />
                        <div className="card-body">
                            <h3 style={{fontSize:'15px', marginBottom:'5px'}}>Cơm quê Món {idx+1}</h3>
                            <p style={{fontSize:'12px', color:'#666'}}>📍 {res.address}</p>
                            <div style={{fontSize:'12px', marginTop:'8px'}}>
      ...
      <footer className="footer-bg">
         <div className="container footer-content">
            <div style={{textAlign:'center'}}>
                <div className="logo-circle" style={{width:'100px', height:'100px', fontSize:'11px', margin:'0 auto'}}>
                    TRAVEL &<br/>TOURISM
                </div>
            </div>
            ...
            <div style={{fontSize:'13px'}}>
                ...
                <p style={{marginBottom:'8px'}}>Email: daynuitruongson@gmail.com</p>
